		...
		<div className="min-h-screen bg-gradient-to-r from-yellow-400 to pink-500 flex flex-col justify-center items-center text-white">
			...
			<div className="flex space-x-4">
				...
				<button
                                ...
                                className="bg-red-500 hover:bg-red-600 text-white font-semib
old py-3 px-8 rounded-full text-lg transition duration-300 shadow-lg transform hover:scale-105"
>
                                Decrement 👎
                                </button>
			</div>
